...
class dbgclassevent;
LOG_ICE_API void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::loggerice::dbgclassevent>&);
LOG_ICE_API ::IceProxy::Ice::Object* upCast(::IceProxy::loggerice::dbgclassevent*);

class dbgclasseventif;
LOG_ICE_API void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::loggerice::dbgclasseventif>&);
...
LOG_ICE_API void __patch(dbgclasseventPtr&, const ::Ice::ObjectPtr&);
...
LOG_ICE_API void __patch(dbgclasseventifPtr&, const ::Ice::ObjectPtr&);
...
public:
    ...
    ::IceInternal::ProxyHandle<dbgclassevent> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<dbgclassevent*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_sendevent(const ::loggerice::dbgclasseventPtr& theevent, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_sendevent(theevent, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_sendevent(const ::loggerice::dbgclasseventPtr& theevent, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_sendevent(theevent, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_sendevent(const ::loggerice::dbgclasseventPtr& theevent, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_sendevent(theevent, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_sendevent(const ::loggerice::dbgclasseventPtr& theevent, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
...
public:
    ...
    ::IceInternal::ProxyHandle<dbgclasseventif> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<dbgclasseventif*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
public:
    ...
    virtual void sendevent(const ::loggerice::dbgclasseventPtr&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual void sendevent(const ::loggerice::dbgclasseventPtr&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    dbgclassevent(::Ice::Int __ice_type, ::Ice::Long __ice_ts, ::Ice::Int __ice_srctype, ::Ice::Int __ice_srcid, ::Ice::Int __ice_kind, ::Ice::Long __ice_key, ::Ice::Long __ice_timeMs, ::Ice::Long __ice_threadId, ::Ice::Int __ice_regId, ::Ice::Long __ice_depth, const ::std::string& __ice_callTxt, ::Ice::Int __ice_subType, ::Ice::Long __ice_elapsedTime) :
