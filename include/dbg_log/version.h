...
#define DBG_LOG_RELEASE_NUMBER   1
#define DBG_LOG_VERSION_STRING   _T("dbg_log 0.0.1")

// Must be updated manually as well each time the version above changes
#define DBG_LOG_VERSION_NUM_DOT_STRING   "0.0.1"
#define DBG_LOG_VERSION_NUM_STRING       "0001"
